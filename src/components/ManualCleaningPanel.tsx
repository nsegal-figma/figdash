...
import type { CleaningSettings, MissingDataStrategy } from '../types/cleaning';
import {
  detectDuplicates,
  detectSpeeders,
  ...
  const handleApplyAIRecommendations = () => {
    ...
    updateSettings({
      ...
      missingData: {
        ...
        strategy: aiRecommendations.missingData.recommendedStrategy as MissingDataStrategy,
      },
    });
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateSettings({
                        missingData: { ...settings.missingData, strategy: e.target.value as MissingDataStrategy },
                      })
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
